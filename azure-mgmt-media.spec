...
Source0  : https://files.pythonhosted.org/packages/54/2c/66d96e3455903d0f15683999e06052aa3505a4c61c279c00d1b8099cef43/azure-mgmt-media-3.0.0.zip
Summary  : Microsoft Azure Media Services Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-media-python = %{version}-%{release}
Requires: azure-mgmt-media-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-media package.
Group: Default
Requires: azure-mgmt-media-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-media package.


%package python3
Summary: python3 components for the azure-mgmt-media package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_media)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-media package.


%prep
%setup -q -n azure-mgmt-media-3.0.0
cd %{_builddir}/azure-mgmt-media-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046844
